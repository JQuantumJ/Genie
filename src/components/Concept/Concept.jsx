      ...
      <div className="accordion-item">
        ...
        {activeIndex === 2 && (
          <div className="accordion-content">
            ...
            <p>그 이유는 사용하는 실험 장치가 측정하는 원자에 영향을 미치기 때문이었습니다.</p>
            <p>입자의 위치와 운동량은 동시에 추론할 수 없으며, 주어진 순간의 에너지도 알 수 없었습니다.</p>
            <p>어떠한 측정이든 어느 정도의 불확정성이 있지만, </p>
            <p>하이젠베르크의 불확정성은 측정 차원의 오류가 아닙니다.</p>
            <p>사용하는 장비가 아무리 정확해도 운동량과 위치를 동시에 정확히 알 수 없다는 것입니다. </p>
            <p>하나의 값을 고정하면 다른 값은 더욱 불확실해집니다.</p>
          </div>
        )}
      </div>
      <div className="accordion-item">
