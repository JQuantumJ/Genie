        ...
        <div className="accordion-item">
          ...
          {activeIndex === 0 && (
            <div className="accordion-content">
              ...
              <p><span style={{color: '#B0E3FF'}}>미국</span>에서는 2019년부터 5년간 최대 13억 달러를 양자기술 연구개발에 투자하고 있으며, 국방부와 정보기관,<br></br> 연구소가 중심이 되어 개발 사업을 본격화하고 있습니다. <br />
              <span style={{color: '#B0E3FF'}}>중국</span>은 세계 최대 규모의 국립양자정보과학연구소를 설립하고, 2018년부터 2022년까지 <br/>약 1천억 위안(약 16.5조 원)을 투자하여 양자통신 분야에서 두각을 나타내고 있습니다. <br/>
              <span style={{color: '#B0E3FF'}}>유럽연합</span>에서는 Quantum Flagship' 프로그램을 통해 양자컴퓨팅, 양자통신 등 <br/>양자응용연구와 상용화를 추진하고 있으며, 2028년까지 10억 유로를 투자하여 양자 연구 리더십 유지와 산업 경쟁력 향상을 목표로 하고 있습니다.</p>      
            </div>
          )}
        </div>
        <div className="accordion-item">
          ...
          {activeIndex === 1 && (
            <div className="accordion-content">
              ...
              <p><span style={{color: '#B0E3FF'}}>국외 정책</span></p>
        ...
        <div className="accordion-item">
          ...
          {activeIndex === 2 && (
            <div className="accordion-content">
              ...
              <p>유럽 주요국은 양자 과학기술 분야에서 공동연구 및 인력교류 등 <span style={{color: '#B0E3FF'}}>국가 간 협력사업</span>을 추진하고 있습니다. 이를 통해 양자기술의 발전과 산업화를 촉진하고 있습니다.</p>
              <p>정부는 국내 산·학·연이 해외 우수 연구기관과 협업할 수 있도록 벨기에에 <span style={{color: '#B0E3FF'}}>'한-유럽 양자 과학센터'</span>를 개소하였습니다. 이를 통해 국제 협력을 강화하고 양자 과학기술의 발전을 도모하고 있습니다.</p>     
            </div>
          )}
        </div>
        <div className="accordion-item">
          ...
          {activeIndex === 3 && (
            <div className="accordion-content">
              <p>양자 기술 산업 생태계는 기업, 연구기관, 정부 등이 협력하여 발전하고 있습니다.<br/>
              국내에서는  <span style={{color: '#B0E3FF'}}>양자산업생태계지원센터(K-QIC)</span>가 설립되어 양자 기술 사업화 및 혁신기업 육성, 양자 정보통신 테스트베드 기반 시험·검증 등을 지원하고 있습니다. </p>    
              <p> 서울시와 한국과학기술연구원(KIST)은 양자 산업 기반을 구축하기 위해 <span style={{color: '#B0E3FF'}}>'양자기술 산업전문과정'</span>을 개설하여 운영하고 있습니다. 이를 통해 양자 기술의 이해와 활용법을 습득하여 연구개발과 사업화를 활성화하고자 합니다.</p>
              <p>이러한 동향은 양자 기술이 미래 산업의 핵심으로 부상하고 있음을 보여주며, 각국의 적극적인 투자와 연구개발이 지속되고 있습니다.</p>  
            </div>
          )}
        </div>
      <div>
