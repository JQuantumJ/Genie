...
`;function X3(){return s.jsx(s.Fragment,{children:s.jsx(q3,{})})}const jf="/assets/coinf-BD3uUSm1.svg",kf="/assets/coinb-CO2sn5vL.svg",Z3="/assets/box1-M57zrF-g.svg",J3="/assets/box2-BABTIy2V.svg",eS=Cr`
  from {
    opacity: 0;
...
`,gS=()=>s.jsxs(g3,{children:[s.jsx(y3,{children:s.jsx("a",{href:"/description",children:s.jsx("img",{src:nc,alt:"Back to main"})})}),s.jsxs(v3,{children:[s.jsx("h1",{children:"양자 컴퓨팅과 계산 복잡도 이론"}),s.jsx("hr",{}),s.jsx("h2",{children:"(1)BPQ(Bounded-Error Quantum Polynomial Time)"}),s.jsxs(Cf,{children:[s.jsxs("p",{children:[s.jsxs("span",{children:["양자 컴퓨터가 효율적으로 풀 수 있는 문제군을 ",s.jsx("span",{style:{color:"#0489B1"},children:"BQP"}),"라 한다."]}),s.jsx("br",{})," 여기서 효율적이란, '정해진 오차범위 내에서 다항 시간 안에' 푼다는 뜻이다. 양자 컴퓨터는 확률적 알고리즘을 실행할 뿐이므로 양자 컴퓨터에 대한 BQP는 기존 컴퓨터에 대한 BPP에 대응한다. ",s.jsx("span",{children:"BPP는 오차 확률을 1/4로 제한하며 다항 시간에 풀 수 있는 문제의 집합으로 정의된다."}),' 양자 컴퓨터가 문제를 "푼다"는 것은 모든 예제에 대해 높은 확률로 올바른 결과가 나온다는 뜻이다. 그 결과가 다항 시간에 나왔다면 그 문제는 BQP에 속한다.',s.jsx("br",{}),"이는 고전적 컴퓨터의 P(Polynomial Time) 클래스와 NP(Nondeterministic Polynomial Time) 클래스에 대응됩니다."]}),s.jsxs("p",{children:["BQP에 속하는 대표적인 문제로는 ",s.jsx("span",{children:"Shor의 소인수분해 알고리즘"}),"과 ",s.jsx("span",{children:"Grover의 검색 알고리즘"}),"이 있습니다. ",s.jsx("br",{}),"Shor의 알고리즘은 고전적인 알고리즘보다 훨씬 효율적으로 큰 수를 소인수분해할 수 있으며, ",s.jsx("br",{}),"Grover의 알고리즘은 비정렬 데이터베이스에서 특정 항목을 검색하는 데 있어 고전적인 알고리즘의 제곱근 시간만큼 소요됩니다."]})]}),s.jsx("h2",{children:"(2)QMA(Quantum Merlin-Arthur)"}),s.jsxs(Cf,{children:[s.jsxs("p",{children:[s.jsxs("span",{children:["QMA는 ",s.jsx("span",{style:{color:"#0489B1"},children:"양자 컴퓨터의 비판자 증명 시스템"}),"에 해당합니다."]})," QMA 클래스는 고전적인 복잡도 이론의 NP 클래스와 유사하지만, 차이점은  ",s.jsx("span",{style:{color:"#0489B1"},children:"증명(proof)이 양자 상태로 제공"}),"된다는 것입니다. 구체적으로, QMA는 검증자가 다항 시간 내에 주어진 양자 증명을 확인할 수 있는 문제들을 포함합니다.",s.jsx("br",{}),"이는 고전적 컴퓨터의 P(Polynomial Time) 클래스와 NP(Nondeterministic Polynomial Time) 클래스에 대응됩니다."]}),s.jsxs("p",{children:["QMA 클래스에 속하는 문제들은 일반적으로 ",s.jsx("span",{children:"QMA-완전(Quantum Merlin-Arthur-comlete)"}),"문제로 분류됩니다. 이는 이러한 문제들이 QMA 내의 모든 문제를 다항식 시간 내에 변환할 수 있을 만큼 복잡하다는 것을 의미합니다. 다표적인 예로는 ",s.jsx("span",{children:"양자 회로의 3-SAT 문제"}),"등 이 있습니다. QMA 클래스의 문제들은 고전적인 컴퓨터로는 해결하기 어려운 문제들이 많으며, 이는 양자 컴퓨팅이 해결할 수 있는 문제의 범위를 확장하는 데 핵심 역할을 합니다."]})]})]})]});function vS(){return s.jsx(s.Fragment,{children:s.jsx(gS,{})})}const yS=()=>{const[e,t]=b.useState(!1),n=()=>{t(!e)};return s.jsxs("div",{children:[s.jsx("div",{style:{zIndex:"20000",position:"fixed",bottom:"9rem",right:"3rem"},children:s.jsx("button",{onClick:n,style:{backgroundColor:"#4CAF50",color:"white",border:"none",borderRadius:"50%",width:"5rem",height:"5rem",fontSize:"24px",cursor:"pointer"},title:"챗봇 열기",children:e?"X":"💬"})}),e&&s.jsx(xS,{children:s.jsx(wS,{allow:"microphone;",src:"https://console.dialogflow.com/api-client/demo/embedded/87fdfc94-6875-4699-a61e-ee1c7fcc7ab2"})})]})},xS=C.div`
  z-index: 10000;
  position: fixed;
  bottom: 9rem;
  right: 10rem;
...
`,kS={title:jn`
    ...
    `,text:jn`
      ...
      font-size: 1.5rem;
      letter-spacing: 0.07em;
    `},CS={fonts:kS};function bS(){return s.jsx(s.Fragment,{children:s.jsxs(By,{theme:CS,children:[s.jsx(jS,{}),s.jsx(SS,{})]})})}Es.createRoot(document.getElementById("root")).render(s.jsx(de.StrictMode,{children:s.jsx(bS,{})}));
