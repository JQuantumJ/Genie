...
`,Wg=P.img`
  max-width: 33%;
  animation: ${Ug} 8s linear infinite;
`,Vg=P.button`
  background-color: #007bff;
  color: white;
  font-size: 1.2rem;
...
`,Hg=()=>{C.useState(!1),C.useState(!1);const[e,t]=C.useState(null),n=Do(),r=i=>{t(e===i?null:i)};return u.jsx(Tg,{children:u.jsxs(Og,{children:[u.jsx("h1",{children:"양자 개념"}),u.jsx("hr",{}),u.jsxs("div",{className:"accordion-item",children:[u.jsxs("div",{className:`accordion-title ${e===0?"active":""}`,onClick:()=>r(0),children:[u.jsx("span",{children:"양자란 ?"}),u.jsx("span",{children:e===0?"▲":"▼"})]}),e===0&&u.jsxs("div",{className:"accordion-content",children:[u.jsxs("p",{style:{marginBottom:"2%"},children:["양자란, 더 이상 나눌 수 없는 에너지의 최소량의 단위입니다. 쉽게 말해, ",u.jsx("span",{style:{color:"#B0E3FF"},children:"우리가 에너지를 가장 작은 단위로 쪼개면 그 단위를 양자"}),"라고 부릅니다. 처음으로 양자는 빛에서 발견되었으며, 이 작은 에너지가 어떻게 움직이는지 연구하는 것이 바로 양자 물리학, 양자 역학의 시작입니다."]}),u.jsx(Ag,{children:u.jsx(Wg,{style:{maxWidth:"30%"},src:Ig})})]})]}),u.jsxs("div",{className:"accordion-item",children:[u.jsxs("div",{className:`accordion-title ${e===1?"active":""}`,onClick:()=>r(1),children:[u.jsx("span",{children:"양자역학이란 ?"}),u.jsx("span",{children:e===1?"▲":"▼"})]}),e===1&&u.jsx("div",{className:"accordion-content",children:u.jsxs("p",{children:["입자 및 입자 집단을 다루는 현대 물리학의 기초 이론입니다. 양자역학은 ",u.jsx("span",{style:{color:"#B0E3FF"},children:"원자와 전자 같은 매우 작은 입자들이 작용하는 방식을 설명하는 이론"}),"으로, 이 입자들은 고전 물리학과는 다르게 파동과 입자 모두의 성질을 가집니다. 그로 인해 입자의 위치나 운동량을 동시에 정확하게 알 수 없다는 불확정성 원리가 등장합니다."]})})]}),u.jsxs("div",{className:"accordion-item",children:[u.jsxs("div",{className:`accordion-title ${e===2?"active":""}`,onClick:()=>r(2),children:[u.jsx("span",{children:"불확정성의 원리"}),u.jsx("span",{children:e===2?"▲":"▼"})]}),e===2&&u.jsxs("div",{className:"accordion-content",children:[u.jsx("h1",{style:{marginBottom:"1%",color:"#eee"},children:'"입자의 위치나 운동량을 동시에 정확하게 알 수 없다"'}),u.jsx("hr",{style:{border:"none",borderTop:"0.5px solid #ddd"}}),u.jsxs("p",{children:["하이젠베르크라는 물리학자는 실험을 통해, 우리가 아무리 정밀한 장비를 사용하더라도 입자의 위치를 알면 그 입자의 속도를 정확히 알 수 없고, 반대로 속도를 알면 위치를 정확히 알 수 없다는 것을 발견했습니다. 이는 마치 ",u.jsx("span",{style:{color:"#B0E3FF"},children:"우리가 축구공을 발로 찬 후에 그 공의 정확한 위치와 속도를 동시에 파악하기 어려운 것"}),"과 비슷합니다. 특히, 측정 차원의 오류가 아니라, 사용하는 장비가 아무리 정확해도 운동량과 위치를 동시에 정확히 알 수 없습니다. 오히려 하나의 값을 고정하면 다른 값은 더욱 불확실해집니다."]}),u.jsxs(Bg,{children:[u.jsx("img",{src:Ng}),u.jsx("img",{src:zg})]})]})]}),u.jsxs("div",{className:"accordion-item",children:[u.jsxs("div",{className:`accordion-title ${e===3?"active":""}`,onClick:()=>r(3),children:[u.jsx("span",{children:"파동-입자 이중성"}),u.jsx("span",{children:e===3?"▲":"▼"})]}),e===3&&u.jsxs("div",{className:"accordion-content",children:[u.jsxs("p",{children:["양자역학의 중요한 개념 중 하나는 ",u.jsx("span",{style:{color:"#B0E3FF"},children:"파동-입자 이중성"}),"입니다. 이는 빛과 물질이 파동과 입자 두 가지 성질을 동시에 가진다는 것입니다. 예를 들어, 전자는 파동처럼 간섭 패턴을 만들 수 있지만, 입자처럼 공간에서 특정 위치에 있을 수 있습니다. 파동-입자 이중성은 물질과 빛이 파동과 입자의 성질을 동시에 가진다는 개념입니다."]}),u.jsxs(Mg,{children:[u.jsx("div",{style:{flex:"1 1 40%",textAlign:"center"},children:u.jsx("img",{src:Lg})}),u.jsx("div",{style:{flex:"1 1 60%",textAlign:"left"},children:u.jsx("p",{children:'빛을 생각해봅시다. 빛은 우리가 매일 접하는 것인데, 고전적인 관점에서 보면 빛은 파동처럼 퍼지며, 렌즈를 통과해 굴절되고 반사되기도 합니다. 예를 들어, 햇빛이 창문을 통해 들어올 때, 그 빛은 창문에서 굴절되고 반사되어 방 안에 퍼집니다. 이때 빛은 파동처럼 행동합니다. 그러나 빛을 어두운 방에서 레이저 포인터로 쏘면 그 레이저 포인터는 특정한 지점에만 빛이 도달하는 것을 볼 수 있습니다. 이때 빛은 마치 총알처럼 특정한 점에 도달하는 "입자"처럼 행동합니다. 이처럼, 빛은 파동처럼 창문에서 굴절되고 퍼질 수 있지만, 특정 조건에서는 입자처럼 특정한 지점에 정확히 도달하는 두 가지 성질을 동시에 가집니다.'})})]})]})]}),u.jsxs("div",{className:"accordion-item",children:[u.jsxs("div",{className:`accordion-title ${e===4?"active":""}`,onClick:()=>r(4),children:[u.jsx("span",{children:"양자 얽힘"}),u.jsx("span",{children:e===4?"▲":"▼"})]}),e===4&&u.jsxs("div",{className:"accordion-content",children:[u.jsxs("p",{children:["양자 얽힘은 ",u.jsx("span",{style:{color:"#B0E3FF"},children:"두 개 이상의 입자가 서로 강하게 연결되어 있는 상태"}),"를 말합니다. 얽힌 입자들은 멀리 떨어져 있어도 얽혀 있어, 서로의 상태에 영향을 미칠 수 있습니다. 두 개의 얽힌 동전 두 개의 동전이 특별한 방법으로 얽혀 있다고 상상해봅시다. 이 동전들을 각각 상자에 넣고 지구의 반대편으로 떨어뜨립니다. 그 후, A 동전의 상자를 열어 동전을 던졌을 때, 앞면이 나왔습니다. 이때, 멀리 떨어진 B 동전은 즉각적으로 뒤집혀서 반드시 뒷면이 나오는 현상을 보여줍니다. 그들은 어떤 방식으로든 얽혀 있어서, A 동전이 앞면이면 B 동전은 뒷면이 될 것이고, 반대로도 성립됩니다."]}),u.jsx("p",{children:'이처럼 양자 얽힘에서는 두 입자가 얽힌 상태에 있으면, 한 입자의 상태가 결정되는 순간 다른 입자의 상태도 그에 맞춰 즉각적으로 결정됩니다. 얽힘 상태에서는 물리적으로 떨어져 있어도 정보가 "순간적으로" 전해지는 것처럼 보입니다.'})]})]}),u.jsxs("div",{className:"accordion-item",children:[u.jsxs("div",{className:`accordion-title ${e===5?"active":""}`,onClick:()=>r(5),children:[u.jsx("span",{children:"양자 중첩(슈뢰딩거의 고양이)"}),u.jsx("span",{children:e===5?"▲":"▼"})]}),e===5&&u.jsxs("div",{className:"accordion-content",children:[u.jsxs("p",{children:["슈뢰딩거의 고양이는 양자역학의 개념을 설명하기 위해 1935년 오스트리아의 물리학자 ",u.jsx("span",{style:{color:"#B0E3FF"},children:"에르빈 슈뢰딩거"}),"가 제안한 사고 실험입니다. 이 실험은 양자역학의 중첩 상태와 그로 인한 철학적 문제를 쉽게 설명하기 위한 것입니다. 특히 양자역학의 코펜하겐 해석을 이해하는 데 중요한 역할을 합니다."]}),u.jsx("div",{style:{textAlign:"center"},children:u.jsx(Vg,{style:{cursor:"pointer"},onClick:i=>n("/cat"),children:" More"})})]})]}),u.jsxs("div",{className:"accordion-item",children:[u.jsxs("div",{className:`accordion-title ${e===6?"active":""}`,onClick:()=>r(6),children:[u.jsx("span",{children:"파동 함수 붕괴"}),u.jsx("span",{children:e===6?"▲":"▼"})]}),e===6&&u.jsxs("div",{className:"accordion-content",children:[u.jsx("h1",{style:{marginBottom:"1%",color:"#eee"},children:"중첩 상태가 관측되었을 때, 그 상태가 하나로 확정되는 과정"}),u.jsx("hr",{style:{border:"none",borderTop:"0.5px solid #ddd"}}),u.jsxs("p",{children:["양자 물체는 여러 상태가 동시에 존재할 수 있는데, 이 상태를 기술하는 것이 ",u.jsx("span",{style:{color:"#B0E3FF"},children:"파동 함수"}),"입니다. 여러 상태가 있더라도 외부에서 관측을 하면 파동 함수가 붕괴하면서 입자는 하나의 확정된 상태로 변화합니다. 파동 함수 붕괴는 양자 중첩 상태에 있는 입자가 관측되었을 때 하나의 확정된 상태로 변하는 과정입니다. 양자 시스템은 여러 상태(중첩 상태)로 존재할 수 있지만, 누군가 그 시스템을 관측하는 순간, 그 시스템은 중첩된 여러 상태 중 하나로 결정됩니다. 이를 파동 함수가 붕괴했다고 표현합니다."]}),u.jsxs(Dg,{children:[u.jsx("img",{src:Di,alt:"cat"})," ",u.jsx("img",{src:Ns,alt:"cat2",style:{maxWidth:"200px",marginBottom:"-47px"}})]}),u.jsx("p",{children:"파동 함수 붕괴는 슈뢰딩거의 고양이에서 상자를 열고 난 후에 발생하는 과정으로 이해할 수 있습니다."})]})]})]})})};function Qg(){return u.jsx(u.Fragment,{children:u.jsx(Hg,{})})}const Gg=P.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,ov=()=>{const e=()=>{window.scrollTo({top:0,behavior:"smooth"})};return u.jsx(u.Fragment,{children:u.jsx(iv,{onClick:e,src:rv,alt:"Scroll to top"})})},lv="/assets/message-D6wtI_nO.svg",sv="/assets/flag-DnSs5bf4.svg",av="data:image/svg+xml,%3csvg%20width='744'%20height='619'%20viewBox='0%200%20744%20619'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20filter='url(%23filter0_f_0_1)'%3e%3cellipse%20cx='352.58'%20cy='364.807'%20rx='208.58'%20ry='110.044'%20fill='%23FDE598'%20fill-opacity='0.7'/%3e%3c/g%3e%3cg%20filter='url(%23filter1_f_0_1)'%3e%3cellipse%20cx='395.735'%20cy='254.044'%20rx='204.265'%20ry='110.044'%20fill='%236955FF'%20fill-opacity='0.5'/%3e%3c/g%3e%3cdefs%3e%3cfilter%20id='filter0_f_0_1'%20x='0.151413'%20y='110.915'%20width='704.858'%20height='507.786'%20filterUnits='userSpaceOnUse'%20color-interpolation-filters='sRGB'%3e%3cfeFlood%20flood-opacity='0'%20result='BackgroundImageFix'/%3e%3cfeBlend%20mode='normal'%20in='SourceGraphic'%20in2='BackgroundImageFix'%20result='shape'/%3e%3cfeGaussianBlur%20stdDeviation='71.9243'%20result='effect1_foregroundBlur_0_1'/%3e%3c/filter%3e%3cfilter%20id='filter1_f_0_1'%20x='47.6214'%20y='0.151413'%20width='696.227'%20height='507.786'%20filterUnits='userSpaceOnUse'%20color-interpolation-filters='sRGB'%3e%3cfeFlood%20flood-opacity='0'%20result='BackgroundImageFix'/%3e%3cfeBlend%20mode='normal'%20in='SourceGraphic'%20in2='BackgroundImageFix'%20result='shape'/%3e%3cfeGaussianBlur%20stdDeviation='71.9243'%20result='effect1_foregroundBlur_0_1'/%3e%3c/filter%3e%3c/defs%3e%3c/svg%3e",uv="/assets/planet-B734ADp0.svg",cv=P.div`
    margin-top: -5%;
    height: 340vh;
    max-height: 340vh;
    margin-bottom: -20%;
...
`,jv=P.img`
  ...
  max-width: 80%;
  margin-right: 15%;
`,Ev=()=>{const[e,t]=C.useState(lt),[n,r]=C.useState(!1),[i,o]=C.useState(!0),[l,s]=C.useState(!1);C.useEffect(()=>{const g=setTimeout(()=>{s(!0)},1e3),v=setInterval(()=>{t(w=>w===lt?go:lt)},600),x=setTimeout(()=>{r(!0),setTimeout(()=>{o(!1)},1e3),clearInterval(v)},3e3);return()=>{clearTimeout(g),clearTimeout(x),clearInterval(v)}},[]);const[a,c]=C.useState(lt),[m,h]=C.useState(!1);return C.useEffect(()=>{const g=setTimeout(()=>{h(!0)},1e3),v=setInterval(()=>{c(x=>x===lt?go:lt)},600);return()=>{clearTimeout(g),clearInterval(v)}},[]),u.jsx(u.Fragment,{children:u.jsxs(cv,{children:[u.jsxs(dv,{children:[i&&u.jsx(u.Fragment,{children:u.jsx(Cv,{src:e,alt:"Waving Genie",isdisappearing:n})}),u.jsxs(xv,{children:[u.jsxs(vv,{children:[u.jsx("img",{src:av,alt:"Gradient Background"}),u.jsxs(yv,{children:[u.jsx("h1",{children:"진인프라의"}),u.jsx("h1",{children:"양자 캐릭터"}),u.jsx("h1",{children:"‘지니’"})]})]}),u.jsx(pv,{children:u.jsx(hv,{src:sv,alt:"Flag"})})]}),u.jsxs(wv,{children:[u.jsx(mv,{children:u.jsx(gv,{src:uv,alt:"planet"})}),u.jsxs(fv,{children:[u.jsx("h1",{children:"지니"}),u.jsx("p",{style:{color:"#0000ff"},children:"지니(진인프라의 진+  접사 ‘-이‘)"}),u.jsx("p",{children:"🧬알라딘에 나오는 무엇이든 할 수 있는 캐릭터 지니처럼"}),u.jsx("p",{children:"🔭양자 정보 관련해서는 무엇이든 알려준다는 의미"})]})]})]}),u.jsxs("div",{style:{maxWidth:"50%",display:"flex",flexDirection:"column",marginLeft:"32%",marginTop:"10%"},children:[u.jsx(Sv,{src:lv,style:{width:"35%",marginLeft:"40%"}}),u.jsx(jv,{style:{marginLeft:"0",marginTop:"3%",marginBottom:"15%"},src:a,alt:"Waving Genie"})]})]})})};function _v(){return u.jsx(u.Fragment,{children:u.jsx(Ev,{})})}const Pv="/assets/bunker-cRaJc6Me.svg",wc="/assets/bottle1-BxjrYTB1.svg",zv="/assets/bottle2-BVqZZ2-9.svg",Nv="data:image/svg+xml,%3csvg%20width='48'%20height='48'%20viewBox='0%200%2048%2048'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_2_1185)'%3e%3cpath%20d='M40%2021.9999H15.66L26.83%2010.8299L24%207.99994L8%2023.9999L24%2039.9999L26.83%2037.1699L15.66%2025.9999H40V21.9999Z'%20fill='black'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_2_1185'%3e%3crect%20width='48'%20height='48'%20fill='white'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e";P.div`
  display: flex;
  flex-direction: row;
  max-width: 100%;
  text-align: center;
...
`,$v={title:un`
    ...
    `,text:un`
      ...
      font-size: 1.5rem;
      letter-spacing: 0.07em;
    `},Ov={fonts:$v};function Fv(){return u.jsx(u.Fragment,{children:u.jsxs(G1,{theme:Ov,children:[u.jsx(Rv,{}),u.jsx(Tv,{})]})})}El.createRoot(document.getElementById("root")).render(u.jsx(ee.StrictMode,{children:u.jsx(Fv,{})}));
