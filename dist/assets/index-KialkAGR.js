...
`,cc="/assets/Genie-Bb0VnGpq.svg";function pg(){const[e,t]=C.useState(!1),[n,r]=C.useState(!1),i=Fo();C.useEffect(()=>{const l=()=>{window.scrollY>0?t(!0):t(!1)};return window.addEventListener("scroll",l),()=>{window.removeEventListener("scroll",l)}},[]);const o=()=>{r(!n)};return u.jsxs(u.Fragment,{children:[u.jsxs(dg,{isScrolled:e,style:{paddingLeft:"5%",paddingRight:"6%"},children:[u.jsxs("div",{onClick:()=>i("/"),style:{cursor:"pointer",maxWidth:"100%",marginRight:"0px",display:"flex",flexDirection:"row",gap:"10%",alignItems:"center",justifyContent:"space-between"},children:[u.jsx(ag,{src:cc,alt:"Logo"}),u.jsx(sg,{children:"Jenie"})]}),u.jsxs("div",{style:{display:"flex",flexDirection:"row",gap:"25px",alignItems:"center",justifyContent:"flex-end"},children:[u.jsx(cg,{children:u.jsx(lg,{})}),u.jsx(uc,{onClick:o,children:n?u.jsx(Ps,{}):u.jsx(og,{})})]})]}),n&&u.jsxs(fg,{children:[u.jsxs("div",{style:{marginBottom:"4%",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"space-between"},children:[u.jsxs("div",{style:{display:"flex",flexDirection:"row",justifyContent:"flex-start",alignItems:"center",fontSize:"1.7rem",gap:"5%"},children:[u.jsx("img",{src:cc}),u.jsx("h1",{children:"Menu List"})]}),u.jsx(uc,{onClick:o,style:{fontSize:"3rem",marginTop:"0.5vw"},children:u.jsx(Ps,{})})]}),u.jsx(yi,{onClick:()=>{i("/concept"),r(!1)},children:"양자 개념"}),u.jsx(yi,{onClick:()=>{i("/description"),r(!1)},children:"양자 활용"}),u.jsx(yi,{onClick:()=>{i("/quiz"),r(!1)},children:"양자 퀴즈"}),u.jsx(yi,{onClick:()=>{i("/character"),r(!1)},children:"캐릭터 소개"})]})]})}const hg=P.footer`
  background: #292F36;
  padding: 3% 0;
