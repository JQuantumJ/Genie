...
`,Rv=()=>{const[e,t]=S.useState(!1),[n,r]=S.useState(!1),[i,o]=S.useState(null);Ao();const l=()=>{const a=Math.random()>.5?"살아 있습니다":"죽었습니다";o(a),t(!0)};return s.jsxs(P0,{children:[s.jsx(N0,{children:s.jsx("a",{href:"/concept",children:s.jsx("img",{src:I0,alt:"Back to main"})})}),s.jsxs(z0,{children:[s.jsx("h1",{children:"슈뢰딩거의 고양이"}),s.jsx("hr",{}),s.jsxs(wi,{children:[s.jsxs(Si,{children:[s.jsx("img",{src:Iv,alt:"bunker",style:{maxWidth:"80%"}})," "]}),s.jsxs(Si,{children:[s.jsx("img",{src:Sc,alt:"bottle1"})," ",s.jsx(Ec,{src:Bi,alt:"cat"})]}),s.jsx("p",{children:"고양이 한 마리와 독이 든 병을 벙커 안에 넣고 벙커를 닫습니다."})]}),s.jsxs(wi,{children:[s.jsxs(Si,{children:[s.jsx("img",{src:Sc,alt:"bottle1"})," ",s.jsx("img",{src:Lv,alt:"bottle2"})]}),s.jsx("p",{children:"독이 든 병은 50%의 확률로 깨질 수도, 깨지지 않을 수도 있습니다."})]}),s.jsxs(wi,{children:[s.jsxs(Si,{children:[s.jsx(Ec,{src:Bi,alt:"cat"})," ",s.jsx(Tv,{src:_0,alt:"cat2"})]}),s.jsx("p",{style:{marginBottom:"1%"},children:"이에 따라 고양이도 죽을 수도 있고 살아 있을 수도 있습니다."}),s.jsxs("p",{style:{padding:"0 2%",marginTop:"0px"},children:["이러한 상태를 ",s.jsx("span",{style:{color:"#0000ff"},children:"양자 중첩 상태"}),"라고 합니다."]}),s.jsx(Ns,{onClick:l,children:"상자 안에 고양이가 있는지 확인하기"})]}),s.jsxs(wi,{children:[s.jsx("p",{style:{padding:"0 2%",marginBottom:"1%"},children:"슈뢰딩거의 고양이는 1935년 에르빈 슈뢰딩거가 양자역학의 이상한 특성을 설명하기 위해 제안한 사고 실험입니다."}),s.jsxs("p",{style:{padding:"0 2%",marginTop:"0px"},children:[s.jsx("span",{children:"이 실험은 고양이를 상자에 넣고, 고양이의 생사 여부가 양자적 현상인 중첩에 의해 결정된다는 개념"}),"을 보여줍니다."]}),s.jsx("div",{style:{textAlign:"center",display:"flex",marginTop:"1%"}}),s.jsx("div",{style:{textAlign:"center",display:"flex",marginTop:"1%"},children:s.jsx(Ns,{onClick:()=>r(!0),children:"추가 설명 보기"})})]}),e&&s.jsx(Cc,{children:s.jsxs(kc,{style:{backgroundColor:"#ddd"},children:[s.jsx(jc,{onClick:()=>t(!1)}),s.jsx("h2",{children:"고양이 상태"}),s.jsx("hr",{}),i==="살아 있습니다"?s.jsxs("div",{children:[s.jsx("p",{children:"고양이는 살아 있습니다!"}),s.jsx("img",{src:Bi,alt:"살아 있는 고양이",style:{maxWidth:"100%"}})]}):s.jsxs("div",{children:[s.jsx("p",{children:"고양이는 죽었습니다...."}),s.jsx("img",{src:Nv,alt:"죽은 고양이",style:{maxWidth:"60%",margin:"1%"}})]})]})}),n&&s.jsx(Cc,{children:s.jsxs(kc,{children:[s.jsx(jc,{onClick:()=>r(!1)}),s.jsx("h2",{children:"추가 설명"}),s.jsx("hr",{}),s.jsxs("p",{children:["이 사고 실험은 양자역학의 중요한 해석 중 하나인 ",s.jsx("span",{style:{fontWeight:"bold"},children:"코펜하겐 해석"}),"을 설명하기 위한 것이었습니다."]}),s.jsx("p",{children:"양자적 입자들은 측정되기 전까지 여러 상태가 동시에 존재하는데, 이 중첩 상태가 외부 관찰에 의해 무너지면서 하나의 확정된 상태가 된다는 것입니다."}),s.jsx("p",{children:s.jsx("span",{children:"고양이 역시 상자를 열어 관찰하기 전까지는 살아있으면서 동시에 죽어있는 상태로 존재합니다."})}),s.jsx("p",{children:"이 실험은 양자역학의 관측 문제와 파동 함수의 붕괴라는 개념을 설명하는 데 중요한 역할을 합니다."}),s.jsxs("p",{children:["슈뢰딩거는 이 실험을 통해 양자역학의 코펜하겐 해석이 현실에 적용될 때 얼마나 비현실적일 수 있는지를 비판했습니다. 실제로 고양이가 ",s.jsx("span",{style:{fontWeight:"bold"},children:'"살아 있으면서 죽어있다"'}),"는 개념은 우리의 일상적인 직관과는 맞지 않기 때문에, 이 실험은 양자역학의 해석에 대한 논쟁을 불러일으켰습니다."]})]})})]})]})};function $v(){return s.jsx(s.Fragment,{children:s.jsx(Rv,{})})}const _c="/assets/coinf-Cfmo5aZr.svg",Pc="/assets/coinb-D-W9u5XS.svg",Ov="/assets/box1-C3lSCEa8.svg",Fv="/assets/box2-DEtiwfco.svg",Mv=Jr`
  from {
    opacity: 0;
...
`,Xv={title:un`
    ...
    `,text:un`
      ...
      font-size: 1.5rem;
      letter-spacing: 0.07em;
    `},Zv={fonts:Xv};function Jv(){return s.jsx(s.Fragment,{children:s.jsxs(eg,{theme:Zv,children:[s.jsx(Kv,{}),s.jsx(Yv,{})]})})}_l.createRoot(document.getElementById("root")).render(s.jsx(ee.StrictMode,{children:s.jsx(Jv,{})}));
