...
`,SS={title:jn`
    ...
    `,text:jn`
      ...
      font-size: 1.5rem;
      letter-spacing: 0.07em;
    `},jS={fonts:SS};function kS(){return s.jsx(s.Fragment,{children:s.jsxs(By,{theme:jS,children:[s.jsx(wS,{}),s.jsx(xS,{})]})})}Es.createRoot(document.getElementById("root")).render(s.jsx(de.StrictMode,{children:s.jsx(kS,{})}));
