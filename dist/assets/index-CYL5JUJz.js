...
`,Fw=b.div`
  display: flex;
  animation: ${Dw} 15s linear infinite;
`,af=b.div`
  width: 25%;
...
`,l3=()=>{const e=()=>{window.scrollTo({top:0,behavior:"smooth"})};return s.jsx(s.Fragment,{children:s.jsx(o3,{onClick:e,src:i3,alt:"Scroll to top"})})},a3="/assets/message-D6wtI_nO.svg",s3="/assets/flag-DnSs5bf4.svg",u3="data:image/svg+xml,%3csvg%20width='744'%20height='619'%20viewBox='0%200%20744%20619'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20filter='url(%23filter0_f_0_1)'%3e%3cellipse%20cx='352.58'%20cy='364.807'%20rx='208.58'%20ry='110.044'%20fill='%23FDE598'%20fill-opacity='0.7'/%3e%3c/g%3e%3cg%20filter='url(%23filter1_f_0_1)'%3e%3cellipse%20cx='395.735'%20cy='254.044'%20rx='204.265'%20ry='110.044'%20fill='%236955FF'%20fill-opacity='0.5'/%3e%3c/g%3e%3cdefs%3e%3cfilter%20id='filter0_f_0_1'%20x='0.151413'%20y='110.915'%20width='704.858'%20height='507.786'%20filterUnits='userSpaceOnUse'%20color-interpolation-filters='sRGB'%3e%3cfeFlood%20flood-opacity='0'%20result='BackgroundImageFix'/%3e%3cfeBlend%20mode='normal'%20in='SourceGraphic'%20in2='BackgroundImageFix'%20result='shape'/%3e%3cfeGaussianBlur%20stdDeviation='71.9243'%20result='effect1_foregroundBlur_0_1'/%3e%3c/filter%3e%3cfilter%20id='filter1_f_0_1'%20x='47.6214'%20y='0.151413'%20width='696.227'%20height='507.786'%20filterUnits='userSpaceOnUse'%20color-interpolation-filters='sRGB'%3e%3cfeFlood%20flood-opacity='0'%20result='BackgroundImageFix'/%3e%3cfeBlend%20mode='normal'%20in='SourceGraphic'%20in2='BackgroundImageFix'%20result='shape'/%3e%3cfeGaussianBlur%20stdDeviation='71.9243'%20result='effect1_foregroundBlur_0_1'/%3e%3c/filter%3e%3c/defs%3e%3c/svg%3e",c3="/assets/planet-B734ADp0.svg",d3=b.div`
    margin-top: -5%;
    margin-bottom: 10%;
    padding-top: 5%;
    background-color: #eee;
...
`,C3=b.img`
  ...
  z-index: 10000;
  transition: opacity 0.5s ease-out;
  animation: ${e=>e.isdisappearing?kn`${j3} 0.5s forwards`:"none"};
  @media (max-width: 800px) {
    position: fixed;
    max-width: 56%;
    left: 22%;
...
`,_3=b.img`
  ...
  max-width: 80%;
  margin-right: 15%;
`,E3=()=>{const[e,t]=_.useState(kt),[n,r]=_.useState(!1),[i,o]=_.useState(!0),[l,a]=_.useState(!1);_.useEffect(()=>{const g=setTimeout(()=>{a(!0)},1e3),y=setInterval(()=>{t(v=>v===kt?fr:kt)},600),x=setTimeout(()=>{r(!0),setTimeout(()=>{o(!1)},1e3),clearInterval(y)},3e3);return()=>{clearTimeout(g),clearTimeout(x),clearInterval(y)}},[]);const[u,c]=_.useState(kt),[h,f]=_.useState(!1);return _.useEffect(()=>{const g=setTimeout(()=>{f(!0)},1e3),y=setInterval(()=>{c(x=>x===kt?fr:kt)},600);return()=>{clearTimeout(g),clearInterval(y)}},[]),s.jsx(s.Fragment,{children:s.jsxs(d3,{children:[s.jsxs(f3,{children:[i&&s.jsx(s.Fragment,{children:s.jsx(C3,{src:e,alt:"Waving Genie",isdisappearing:n})}),s.jsxs(w3,{children:[s.jsxs(y3,{children:[s.jsx("img",{src:u3,alt:"Gradient Background"}),s.jsxs(x3,{children:[s.jsx("h1",{children:"진인프라의"}),s.jsx("h1",{children:"양자 캐릭터"}),s.jsx("h1",{children:"‘지니’"})]})]}),s.jsx(h3,{children:s.jsx(m3,{src:s3,alt:"Flag"})})]}),s.jsxs(S3,{children:[s.jsx(g3,{children:s.jsx(v3,{src:c3,alt:"planet"})}),s.jsxs(p3,{children:[s.jsx("h1",{children:"지니"}),s.jsx("p",{style:{color:"#0000ff"},children:"지니(진인프라의 진+  접사 ‘-이‘)"}),s.jsx("p",{children:"🧬알라딘에 나오는 무엇이든 할 수 있는 캐릭터 지니처럼"}),s.jsx("p",{children:"🔭양자 정보 관련해서는 무엇이든 알려준다는 의미"})]})]})]}),s.jsxs("div",{style:{maxWidth:"50%",display:"flex",flexDirection:"column",marginLeft:"32%",marginTop:"10%"},children:[s.jsx(k3,{src:a3,style:{width:"35%",marginLeft:"40%"}}),s.jsx(_3,{style:{marginLeft:"0",marginTop:"3%",marginBottom:"15%"},src:u,alt:"Waving Genie"})]})]})})};function O3(){return s.jsx(s.Fragment,{children:s.jsx(E3,{})})}const b3="/assets/cat3-Bspolb1q.svg",P3="/assets/bunker-cRaJc6Me.svg",cf="/assets/bottle1-BxjrYTB1.svg",T3="/assets/bottle2-BVqZZ2-9.svg",pm="data:image/svg+xml,%3csvg%20width='48'%20height='48'%20viewBox='0%200%2048%2048'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_2_1185)'%3e%3cpath%20d='M40%2021.9999H15.66L26.83%2010.8299L24%207.99994L8%2023.9999L24%2039.9999L26.83%2037.1699L15.66%2025.9999H40V21.9999Z'%20fill='black'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_2_1185'%3e%3crect%20width='48'%20height='48'%20fill='white'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e";b.div`
  display: flex;
  flex-direction: row;
  max-width: 100%;
  text-align: center;
...
`,L3=()=>{const[e,t]=_.useState(!1),[n,r]=_.useState(!1),[i,o]=_.useState(null);zt();const l=()=>{const a=Math.random()>.5?"살아 있습니다":"죽었습니다";o(a),t(!0)};return s.jsxs(mh,{children:[s.jsx(vh,{children:s.jsx("a",{href:"/concept",children:s.jsx("img",{src:pm,alt:"Back to main"})})}),s.jsxs(gh,{children:[s.jsx("h1",{children:"슈뢰딩거의 고양이"}),s.jsx("hr",{}),s.jsxs(Qi,{children:[s.jsxs(Gi,{children:[s.jsx("img",{src:P3,alt:"bunker",style:{maxWidth:"80%"}})," "]}),s.jsxs(Gi,{children:[s.jsx("img",{src:cf,alt:"bottle1"})," ",s.jsx(hf,{src:fo,alt:"cat"})]}),s.jsx("p",{children:"고양이 한 마리와 독이 든 병을 벙커 안에 넣고 벙커를 닫습니다."})]}),s.jsxs(Qi,{children:[s.jsxs(Gi,{children:[s.jsx("img",{src:cf,alt:"bottle1"})," ",s.jsx("img",{src:T3,alt:"bottle2"})]}),s.jsx("p",{children:"독이 든 병은 50%의 확률로 깨질 수도, 깨지지 않을 수도 있습니다."})]}),s.jsxs(Qi,{children:[s.jsxs(Gi,{children:[s.jsx(hf,{src:fo,alt:"cat"})," ",s.jsx(z3,{src:hh,alt:"cat2"})]}),s.jsx("p",{style:{marginBottom:"1%"},children:"이에 따라 고양이도 죽을 수도 있고 살아 있을 수도 있습니다."}),s.jsxs("p",{style:{padding:"0 2%",marginTop:"0px"},children:["이러한 상태를 ",s.jsx("span",{style:{color:"#0000ff"},children:"양자 중첩 상태"}),"라고 합니다."]}),s.jsx(Ps,{onClick:l,children:"벙커 안에 고양이가 있는지 확인하기"})]}),s.jsxs(Qi,{children:[s.jsx("p",{style:{padding:"0 2%",marginBottom:"1%"},children:"슈뢰딩거의 고양이는 1935년 에르빈 슈뢰딩거가 양자역학의 이상한 특성을 설명하기 위해 제안한 사고 실험입니다."}),s.jsxs("p",{style:{padding:"0 2%",marginTop:"0px"},children:[s.jsx("span",{children:"이 실험은 고양이를 상자에 넣고, 고양이의 생사 여부가 양자적 현상인 중첩에 의해 결정된다는 개념"}),"을 보여줍니다."]}),s.jsx("div",{style:{textAlign:"center",display:"flex",marginTop:"1%"}}),s.jsx("div",{style:{textAlign:"center",display:"flex",marginTop:"1%"},children:s.jsx(Ps,{onClick:()=>r(!0),children:"추가 설명 보기"})})]}),e&&s.jsx(df,{children:s.jsxs(ff,{style:{backgroundColor:"#ddd"},children:[s.jsx(pf,{onClick:()=>t(!1)}),s.jsx("h2",{children:"벙커의 문이 열렸습니다!"}),s.jsx("hr",{}),i==="살아 있습니다"?s.jsxs("div",{children:[s.jsx("p",{children:"고양이는 살아 있습니다!"}),s.jsx("img",{src:fo,alt:"살아 있는 고양이",style:{maxWidth:"100%"}})]}):s.jsxs("div",{children:[s.jsx("p",{children:"고양이는 죽었습니다...."}),s.jsx("img",{src:b3,alt:"죽은 고양이",style:{maxWidth:"60%",margin:"1%"}})]})]})}),n&&s.jsx(df,{children:s.jsxs(ff,{children:[s.jsx(pf,{onClick:()=>r(!1)}),s.jsx("h2",{children:"추가 설명"}),s.jsx("hr",{}),s.jsxs("p",{children:["이 사고 실험은 양자역학의 중요한 해석 중 하나인 ",s.jsx("span",{style:{fontWeight:"bold"},children:"코펜하겐 해석"}),"을 설명하기 위한 것이었습니다."]}),s.jsx("p",{children:"양자적 입자들은 측정되기 전까지 여러 상태가 동시에 존재하는데, 이 중첩 상태가 외부 관찰에 의해 무너지면서 하나의 확정된 상태가 된다는 것입니다."}),s.jsx("p",{children:s.jsx("span",{children:"고양이 역시 상자를 열어 관찰하기 전까지는 살아있으면서 동시에 죽어있는 상태로 존재합니다."})}),s.jsx("p",{children:"이 실험은 양자역학의 관측 문제와 파동 함수의 붕괴라는 개념을 설명하는 데 중요한 역할을 합니다."}),s.jsxs("p",{children:["슈뢰딩거는 이 실험을 통해 양자역학의 코펜하겐 해석이 현실에 적용될 때 얼마나 비현실적일 수 있는지를 비판했습니다. 실제로 고양이가 ",s.jsx("span",{style:{fontWeight:"bold"},children:'"살아 있으면서 죽어있다"'}),"는 개념은 우리의 일상적인 직관과는 맞지 않기 때문에, 이 실험은 양자역학의 해석에 대한 논쟁을 불러일으켰습니다."]})]})})]})]})};function I3(){return s.jsx(s.Fragment,{children:s.jsx(L3,{})})}const mf="/assets/coinf-BD3uUSm1.svg",gf="/assets/coinb-CO2sn5vL.svg",R3="/assets/box1-M57zrF-g.svg",N3="/assets/box2-BABTIy2V.svg",M3=Cr`
  from {
    opacity: 0;
...
`,H3=()=>{const[e,t]=_.useState(!1),[n,r]=_.useState(null),[i,o]=_.useState(null),[l,a]=_.useState(!1),u=()=>{const c=Math.random()>.5?"앞면":"뒷면";r(c),o(c==="앞면"?"뒷면":"앞면"),a(!0)};return s.jsxs(mh,{children:[s.jsx(vh,{children:s.jsx("a",{href:"/concept",children:s.jsx("img",{src:pm,alt:"Back to main"})})}),s.jsxs(gh,{children:[s.jsx("h1",{children:"양자 얽힘: 두 개의 얽힌 동전"}),s.jsx("hr",{}),s.jsxs($3,{children:[s.jsx("p",{children:"두 개의 동전이 특별한 방식으로 얽혀 있습니다."}),s.jsx("p",{children:"한 동전의 상태가 결정되면 다른 동전의 상태도 자동으로 결정됩니다!"}),s.jsx("p",{children:"박스를 열어서 동전 A를 확인하세요."}),s.jsx("h1",{style:{color:"#0183ff",margin:"5%"},children:"박스 클릭하기"}),l&&s.jsxs(F3,{children:[s.jsxs("div",{style:{textAlign:"center"},children:[s.jsx("h3",{children:"동전 A"}),s.jsx("img",{src:n==="앞면"?mf:gf,alt:"동전 A",style:{maxWidth:"160px"}}),s.jsx("p",{children:n})]}),s.jsxs("div",{style:{textAlign:"center"},children:[s.jsx("h3",{children:"동전 B"}),s.jsx("img",{src:i==="앞면"?mf:gf,alt:"동전 B",style:{maxWidth:"160px"}}),s.jsx("p",{children:i})]})]}),s.jsx(D3,{src:l?N3:R3,alt:"박스",onClick:u}),s.jsx("div",{style:{textAlign:"center",display:"flex",marginTop:"1%"},children:s.jsx(Ps,{onClick:()=>t(!0),children:"추가 설명 보기"})})]}),e&&s.jsx(A3,{children:s.jsxs(B3,{children:[s.jsx(W3,{onClick:()=>t(!1)}),s.jsx("h2",{children:"양자 얽힘 설명"}),s.jsx("hr",{}),s.jsx("p",{children:"두 개의 동전이 특별한 방법으로 얽혀 있다고 상상해봅시다. 이 동전들을 각각 상자에 넣고 지구의 반대편으로 떨어뜨립니다. 그 후, A 동전의 상자를 열어 동전을 확인했을 때, 앞면이 나왔습니다."}),s.jsx("p",{children:"이때, 멀리 떨어진 B 동전은 즉각적으로 뒤집혀서 반드시 뒷면이 나옵니다. 그들은 어떤 방식으로든 얽혀 있어서, A 동전이 앞면이면 B 동전은 뒷면이 될 것이고, 반대로도 성립됩니다."}),s.jsx("p",{children:'이처럼 양자 얽힘에서는 두 입자가 얽힌 상태에 있으면, 한 입자의 상태가 결정되는 순간 다른 입자의 상태도 그에 맞춰 즉각적으로 결정됩니다. 얽힘 상태에서는 물리적으로 떨어져 있어도 정보가 "순간적으로" 전해지는 것처럼 보입니다.'})]})})]})]})};function U3(){return s.jsx(s.Fragment,{children:s.jsx(H3,{})})}const V3=()=>{const{pathname:e}=Mu();return _.useEffect(()=>{window.scrollTo(0,0)},[e]),null},Q3={ibm:{title:"IBM",description:"IBM Quantum은 클라우드 기반 양자 컴퓨팅 서비스로, 개발자와 연구자들에게 실용적인 양자 컴퓨팅을 제공합니다.",imgSrc:lm},dwave:{title:"D-Wave",description:"D-Wave는 양자 어닐링(annealing) 기반 시스템을 제공하며, 최적화 문제 해결에 특화된 양자 컴퓨터를 개발합니다.",imgSrc:am},rigetti:{title:"Rigetti Computing",description:"Rigetti Computing은 양자 회로 기반 시스템을 개발하며, 하이브리드 양자-클래식 컴퓨팅을 통해 양자 컴퓨팅을 상용화하려고 합니다.",imgSrc:sm},honeywell:{title:"Honeywell",description:"Honeywell Quantum Solutions는 이온 트랩 기술을 사용한 양자 컴퓨터를 개발하여 정밀한 양자 계산을 제공합니다.",imgSrc:As},google:{title:"Google",description:"Google Quantum AI는 시너지 효과를 노리며, 인공지능과 양자 컴퓨팅의 결합을 통해 양자 우월성을 목표로 연구 중입니다.",imgSrc:As},microsoft:{title:"Microsoft",description:"Honeywell Quantum Solutions는 이온 트랩 기술을 사용한 양자 컴퓨터를 개발하여 정밀한 양자 계산을 제공합니다.",imgSrc:um},intel:{title:"Intel",description:"Intel은 양자 컴퓨팅 하드웨어와 소프트웨어 생태계를 구축하고 있으며, 상용화 가능한 양자 프로세서를 개발 중입니다.",imgSrc:dm},alibaba:{title:"Alibaba",description:"Alibaba는 클라우드 기반의 양자 컴퓨팅 서비스를 제공하며, 양자 암호화 및 인공지능 연구에 집중하고 있습니다.",imgSrc:fm},jininfra:{title:"JinInfra",description:"JinInfra는 양자 네트워크 인프라와 보안 솔루션을 개발하여 양자 통신 기술 상용화에 주력하고 있습니다.",imgSrc:cm}},G3=()=>{const{companyName:e}=v1(),t=Q3[e.toLowerCase()];return t?s.jsxs(Jh,{children:[s.jsx(em,{children:s.jsx(tm,{children:t.title})}),s.jsx(nm,{children:s.jsxs(rm,{children:[s.jsx(im,{children:t.title}),s.jsx(om,{children:t.description})]})})]}):s.jsx("p",{children:"존재하지 않는 기업입니다."})};function q3(){return s.jsxs(N1,{children:[s.jsx(u2,{}),s.jsx(V3,{}),s.jsxs(L1,{children:[s.jsx(Ne,{path:"/",element:s.jsx(qy,{})}),s.jsx(Ne,{path:"/concept",element:s.jsx(L2,{})}),s.jsx(Ne,{path:"/description",element:s.jsx(r3,{})}),s.jsx(Ne,{path:"/quiz",element:s.jsx(R2,{})}),s.jsx(Ne,{path:"/medium",element:s.jsx(D2,{})}),s.jsx(Ne,{path:"/advanced",element:s.jsx(A2,{})}),s.jsx(Ne,{path:"/quizmain",element:s.jsx(M2,{})}),s.jsx(Ne,{path:"/character",element:s.jsx(O3,{})}),s.jsx(Ne,{path:"/cat",element:s.jsx(I3,{})}),s.jsx(Ne,{path:"/company",element:s.jsx(Qw,{})}),s.jsx(Ne,{path:"/company/:companyName",element:s.jsx(G3,{})}),s.jsx(Ne,{path:"/recent",element:s.jsx(Jw,{})}),s.jsx(Ne,{path:"/coinentanglement",element:s.jsx(U3,{})})]}),s.jsx(l3,{}),s.jsx(w2,{})]})}const K3=By`
  :root {
    --vh: 100%;
    background-color: #eee;
  }
...
`,Y3={title:kn`
    ...
    `,text:kn`
      ...
      font-size: 1.5rem;
      letter-spacing: 0.07em;
    `},X3={fonts:Y3};function Z3(){return s.jsx(s.Fragment,{children:s.jsxs(Dy,{theme:X3,children:[s.jsx(K3,{}),s.jsx(q3,{})]})})}Ea.createRoot(document.getElementById("root")).render(s.jsx(de.StrictMode,{children:s.jsx(Z3,{})}));
